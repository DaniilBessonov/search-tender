...
var msgBoxImagePath = contextPath + "/images/";
...
function msg (options) {
    ...
    switch (options.type) {
        case "alert":
            ...
            break;
        case "info":
            image = "msgbox_info.png";
            break;
        case "error":
            image = "msgbox_error.png";
            break;
        case "confirm":
            image = "msgbox_confirm.png";
            break;
        default:
            image = "msgbox_alert.png";
    }
    ...
    var divTitle = "<div class=\"msgBoxTitle\">" + options.title + "<span class='closePopUp'></span></div>";
    var divContainer = "<div class=\"msgBoxContainer\"><div class=\"msgBoxImage\"><img src=\""+ msgBoxImagePath + image + "\"/></div><div class=\"msgBoxContent\"><p><span>" + options.content + "</span></p></div></div>";
